...
local DiffNames={
	...
	"Extreme", -- Difficulty_Hard
	"Resolve", -- Difficulty_Challenge
	"Custom" -- Difficulty_Edit
}
local DiffImage={
	-- 習/楽/踊/激/鬼/創 -- Thanks paraph.
	"簡単", -- Difficulty_Beginner
	"基本", -- Difficulty_Easy
	"難しい", -- Difficulty_Medium
	"過激", -- Difficulty_Hard
	"解決", -- Difficulty_Challenge
	"習慣" -- Difficulty_Edit
}
...
return function(Style)
	...
	for i = 1,13 do
		...
		Wheel[#Wheel+1] = Def.ActorFrame{
			...
			Def.Sprite{
				Texture=THEME:GetPathG("","MAX/BackPlate"),
	...
	for i = 0,1 do
		Diffs[#Diffs+1] = Def.ActorFrame{
			...
			Def.Sprite{
				Texture=THEME:GetPathG("","MAX/DiffMAX"),
				OnCommand=function(self)
	...
	return Def.ActorFrame{
		...
		Def.Sprite{
			Texture=THEME:GetPathG("MAX/InfoMAX","Display"),
			OnCommand=function(self) 
		...
		Def.ActorFrame{
			...
			Def.Sprite{
				Texture=THEME:GetPathG("","MAX/MAXSelector"),
				OnCommand=function(self) 
					self:diffuse(DisplayColor[1],DisplayColor[2],DisplayColor[3],1)
				end
			},
		...
		Def.Sprite{
			Texture=THEME:GetPathG("","MAX/Radar"),
			OnCommand=function(self)	
