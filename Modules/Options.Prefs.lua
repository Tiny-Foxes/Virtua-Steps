...
return {
	...
	SpeedModType =
	{
		Default = "x",
		UserPref = true,
		Choices = { THEME:GetString("OptionNames","SpeedX"), THEME:GetString("OptionNames","SpeedA"), THEME:GetString("OptionNames","SpeedM"), THEME:GetString("OptionNames","SpeedC"), THEME:GetString("OptionNames","SpeedCA") },
		Values = {"x","a","m","c","ca"},
		LoadFunction = function(self,list,pn)
	...
	judgmentscatter =
	{
		...
		SaveFunction = function(self, list)
			local Location = "Save/LocalProfiles/".. GAMESTATE:GetEditLocalProfileID() .."/VirtuaPrefs.ini"
			for i,_ in ipairs(self.Values) do
				if list[i] == true then
