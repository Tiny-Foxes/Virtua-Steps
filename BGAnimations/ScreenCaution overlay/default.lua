...
t[#t+1] = Def.ActorFrame {
	...
	Def.Quad {
		...
		OnCommand=cmd(diffuse,color("#00FFE0");shadowcolor,BoostColor(color("#00FFE077"),0.25);linear,0.25;zoomtowidth,256;fadeleft,0.25;faderight,0.25);
	};
	LoadFont("Common Large") .. {
		Text=Screen.String("Caution");
		OnCommand=cmd(skewx,-0.125;diffuse,color("#00FFE0");strokecolor,ColorDarkTone(color("#00FFE0")));
	};
