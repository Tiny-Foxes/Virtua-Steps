...
local x = Def.ActorFrame{
	...
	Def.Quad {
		...
		OnCommand=function(self) self:diffuse(color("#05FFFF")):diffusebottomedge(color("#0066F0")) end
	},
}
...
x[#x+1] = Def.ActorFrame {
	LoadActor("_checkerboard") .. {
		...
		OnCommand=cmd(texcoordvelocity,0,0.25;diffuse,color("#00FFFB");fadetop,1);
	}
}
