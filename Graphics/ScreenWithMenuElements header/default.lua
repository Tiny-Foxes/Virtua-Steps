...
return Def.ActorFrame{
	...
	Def.Sprite{
		...
		OnCommand=function(self)
			self:texcoordvelocity(2,0):skewx(-0.0575):diffuse(color("#006B93"))
			:diffuserightedge(color("#003549")) end,
	},
	Def.Sprite{
		Texture= THEME:GetPathG("ScreenWithMenuElements","header/Header"),
		InitCommand=function(self) self:y(1):vertalign(top):zoomtowidth(SCREEN_WIDTH+1):diffuse(color("#00FFE0")) end,
	...
	Def.BitmapText{
		...
		OnCommand=function(self)
			self:visible(IsVisible()):skewx(-0.125):diffuse(BoostColor(color("#00FFE077"),0.375)) end,
	...
	Def.Quad {
		...
		OnCommand=function(self)
			self:stoptweening():diffuse(color("#00FFE0")):shadowlength(2)
			:shadowcolor(BoostColor(color("#00FFE077"),0.25)):linear(0.25):zoomtowidth(192)
	...
	Def.BitmapText{
		...
		OnCommand=function(self) self:visible(IsVisible()):skewx(-0.125):diffuse(color("#00FFE0")) end,
		UpdateScreenHeaderMessageCommand=function(self,param)
			self:settext(param.Header)
		end
	}
